...
const createPlaylist = (uris) => {
  ...
  $.ajax({
    ...
    data: JSON.stringify({
      ...
      description: "generated by Telcotify07 (Telcotify07.herokuapp.com)",
      public: true,
    }),
    success: function (data) {
...
const displayReceipt = (response, stats) => {
  ...
  userProfilePlaceholder.innerHTML = userProfileTemplate({
    ...
    receiptTitle:
      showSearch && response.name ? response.name.toUpperCase() : "Telcotify07",
